...
```bash
# イメージをプル
docker pull ghcr.io/k2works/case-study-bouquet:latest

# または特定バージョン
docker pull ghcr.io/k2works/case-study-bouquet:0.0.1

# コンテナを実行
docker run -it -v $(pwd):/srv ghcr.io/k2works/case-study-bouquet:latest
```
