...
- [ ] 認証基盤の実装（Spring Security + JWT）
- [ ] US-017: システムにログインする（5 SP）
- [ ] US-018: 得意先アカウント新規登録（3 SP）
- [ ] US-003: 単品（花材）を登録する（3 SP）
- [ ] 開発パターンの確立（ヘキサゴナルアーキテクチャの各レイヤー実装テンプレート）
...
- [ ] US-001: 商品（花束）を登録する（3 SP）
- [ ] US-002: 花束の構成を定義する（5 SP）
- [ ] US-004: 商品一覧を表示する（3 SP）
- [ ] フロントエンド商品管理画面
...
|---------------|------|---------|---------|--------|------|
| 1 | 03/24 - 04/04 | 11 | - | - | 計画済み |
| 2 | 04/07 - 04/18 | 11 | - | - | 未着手 |
| 3 | 04/21 - 05/02 | 13 | - | - | 未着手 |
| 4 | 05/04 - 05/15 | 16 | - | - | 未着手 |
