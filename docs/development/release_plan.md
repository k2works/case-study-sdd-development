...
- **イテレーション**: 2 週間 × 8 イテレーション（7 実装 + 1 バッファ）
...
gantt
    ...
    section バッファ
    IT8 品質保証・リリース           :active, buf, after p3-1, 14d
    Release 3.0 最終リリース         :milestone, mf, after buf, 0d
```
...
gantt
    ...
    section バッファ
    IT8 品質保証・リリース (-)       :buf, after p3-1, 14d
    Release 3.0                      :milestone, m3, after buf, 0d
```
...
- ~~US-011: 入荷を登録する（3 SP）~~ → IT5 に移動（レビュー指摘反映）
...
- [x] US-011: 入荷を登録する（3 SP）※IT4 から移動
- [x] US-012: 結束対象を確認する（3 SP）
- [x] US-013: 結束完了を登録する（5 SP）
- [x] IT4 技術負債解消（InventoryQueryPort 実装完成）
...
- [x] US-014: 出荷処理を実行する（3 SP）※IT5 から移動
- [x] US-019: 注文をキャンセルする（5 SP）
- [x] US-008: 届け日を変更する（8 SP）
- [x] Phase 2 リリース準備
...
- [x] US-015: 届け先をコピーする（5 SP）
- [x] US-016: 得意先情報を確認する（3 SP）
- [x] ダッシュボード S-100 3 カード構成実装（レビュー起因追加対応）
- [ ] Phase 3 リリース準備 → IT8 に移動
- [ ] 全体回帰テスト → IT8 に移動
...
### イテレーション 8（バッファ: 2026-06-29 ~ 2026-07-10）

**ゴール**: 全フェーズの品質保証を完了し、Release 3.0 をリリースする

**主なタスク**:

- [ ] 統合テスト（届け先一覧 + 得意先管理 + 認可テスト）
- [ ] フロントエンドコンポーネントテスト
- [ ] E2E テスト（リピート注文フロー + 得意先管理）
- [ ] 全フェーズ回帰テスト（Phase 1-3 主要フロー）
- [ ] Clock 注入リファクタリング（3 箇所）
- [ ] ArchUnit テスト検証
- [ ] Release 3.0 リリース準備（CHANGELOG + バージョンバンプ + タグ）
- [ ] プロジェクト完了報告書
...
| 5 | 05/18 - 05/29 | 11 | 11 | 100% | 完了 |
| 6 | 06/01 - 06/12 | 16 | 16 | 100% | 実装完了 |
| 7 | 06/15 - 06/26 | 8 | 8 | 100% | 実装完了 |
| 8（バッファ） | 06/29 - 07/10 | 0 | 0 | 100% | 完了 |
...
1. IT8 で Clock 注入リファクタリング（3 箇所）を実施する
2. 統合テスト・E2E テスト・全フェーズ回帰テストを実施する
3. ArchUnit テスト検証 + テストカバレッジ確認
4. Release 3.0 リリース準備（CHANGELOG、バージョンバンプ、タグ）を完了する
5. プロジェクト完了報告書を作成する
...
|------|---------|--------|
| 2026-03-20 | 初版作成 | - |
| 2026-03-22 | IT5 完了に伴う進捗更新 | - |
| 2026-03-21 | IT3 完了に伴う進捗更新 | - |
| 2026-03-22 | IT4 完了に伴う進捗更新。US-009, US-010 完了（13SP）。US-011 は IT5 に移動。累計 48/83 SP（58%） | - |
| 2026-03-22 | IT5 計画作成。US-014 を IT6 に移動。IT5 = US-011 + US-012 + US-013 = 11SP | - |
| 2026-03-22 | IT5 レビュー反映。IT4 セクション US-011 取消線化、進捗テーブル IT6 計画 SP 13→16、バーンダウン計画線修正（IT5: 35→24、IT6: 24→8） | - |
| 2026-03-22 | IT5 完了報告書作成。Phase 1 MVP 完了（51/51 SP）、全フェーズ 59/83 SP（71%） | - |
| 2026-03-23 | IT6 実装完了。US-014, US-019, US-008 実装（16SP）。Phase 2 実装完了（24/24 SP）、全フェーズ 75/83 SP（90%） | - |
| 2026-03-23 | IT7 計画作成。US-015（5SP）+ US-016（3SP）= 8SP。Phase 3 最終イテレーション | - |
| 2026-03-23 | IT7 実装完了。US-015/US-016 実装（8SP）+ ダッシュボード S-100 改善。全フェーズ 83/83 SP（100%）。テスト 361 件全通過、行カバレッジ 88.5% | - |
| 2026-03-23 | IT8（バッファイテレーション）計画作成。IT7 残存タスク（統合テスト・E2E・回帰テスト・Clock 注入・ArchUnit・リリース準備）を IT8 に移動。24.5h/80h で品質保証に集中 | - |
