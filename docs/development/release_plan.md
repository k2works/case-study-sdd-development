...
1. イテレーション 7 の開発を開始し、US-015（届け先コピー）から TDD で着手する
2. US-016（得意先情報確認）のバックエンド→フロントエンドの順で実装する
3. 全フェーズ回帰テスト（Phase 1-3）を実施する
4. Release 3.0 リリース準備（CHANGELOG、バージョンバンプ）を完了する
