...
- [x] US-015: 受注状況確認（3SP）
- [x] US-016: 注文履歴確認（3SP）
- [x] XP マルチパースペクティブレビュー + 指摘対応

**実績 SP**: 9 / 9（達成率 100%）

### イテレーション 5（Week 9-10）✅ 完了
...
- [x] US-008: 仕入先に発注（5SP）
- [x] US-009: 入荷受入（5SP）
- [x] US-012: 品質維持期限アラート（3SP）
- [x] 在庫推移に入荷予定を反映（StockForecastService 拡張）

**実績 SP**: 13 / 13（達成率 100%）

### イテレーション 6（Week 11-12）✅ 完了

**ゴール**: 出荷管理と届け日変更を完成させ、全機能リリース

**主なタスク**:

- [x] OrderStatus 拡張（PREPARING, SHIPPED 追加）
- [x] US-010: 結束対象確認（3SP）
- [x] US-011: 出荷処理・通知（5SP）
- [x] US-013: 届け日変更（5SP）
...
1. Release v0.2.0 リリース準備
2. 全体統合テスト・負荷テスト（Locust）
3. ステージング環境での動作確認
...
| 2026-03-24 | IT4 実績反映（9/9SP 達成）、Phase 1 MVP 完了、ベロシティ更新（平均 9.25SP） | - |
| 2026-03-25 | IT5 実績反映（13/13SP 達成）、IT6 実績反映（13/13SP 達成）、Phase 2 完了 | - |
