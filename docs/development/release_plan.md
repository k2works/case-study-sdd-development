...
1. IT7 の統合テスト・E2E テスト・回帰テストを実施する（タスク 3.1-3.5）
2. ArchUnit テスト検証 + テストカバレッジ確認（タスク 3.7）
3. Release 3.0 リリース準備（CHANGELOG、バージョンバンプ）を完了する（タスク 3.8）
4. プロジェクト完了報告書を作成する
