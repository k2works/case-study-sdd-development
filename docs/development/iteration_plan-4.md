...
| # | タスク | 見積もり | 状態 |
| :--- | :--- | :--- | :--- |
| 1.1 | ドメイン層: OrderRepository に一覧取得・フィルタ IF 追加 | 1h | [x] |
| 1.2 | インフラ層: DjangoOrderRepository に一覧取得・フィルタ実装 + 統合テスト | 2h | [x] |
| 1.3 | Application 層: OrderService に一覧取得メソッド追加 | 1h | [x] |
| 1.4 | Django View: 受注一覧画面（ステータス・日付フィルタ）+ URL ルーティング | 2h | [x] |
| 1.5 | Django View: 受注詳細画面 + URL ルーティング | 1.5h | [x] |
| 1.6 | Django Template: 受注一覧 + 受注詳細テンプレート | 2h | [x] |
| 1.7 | テスト: 受注一覧・詳細の View 統合テスト | 1.5h | [x] |
...
| # | タスク | 見積もり | 状態 |
| :--- | :--- | :--- | :--- |
| 2.1 | Django View: 注文検索画面（注文番号入力→注文一覧）| 1.5h | [x] |
| 2.2 | Django View: 注文詳細画面（届け先・メッセージ・ステータス + キャンセル導線）| 1.5h | [x] |
| 2.3 | Django Template: 注文検索 + 注文詳細テンプレート | 2h | [x] |
| 2.4 | テスト: 注文検索・詳細の View 統合テスト | 1.5h | [x] |
...
| # | タスク | 見積もり | 状態 |
| :--- | :--- | :--- | :--- |
| 3.1 | ドメイン層: OrderRepository に届け先一覧取得 IF 追加 | 0.5h | [x] |
| 3.2 | インフラ層: DjangoOrderRepository に届け先一覧取得実装 | 1.5h | [x] |
| 3.3 | Application 層: OrderService に届け先一覧取得メソッド追加 | 1h | [x] |
| 3.4 | Django View: 注文フォームに「過去の届け先を利用」機能追加 | 2h | [x] |
| 3.5 | Django Template: 届け先選択画面（C-06 相当） | 1.5h | [x] |
| 3.6 | テスト: 届け先コピーの統合テスト | 1.5h | [x] |
