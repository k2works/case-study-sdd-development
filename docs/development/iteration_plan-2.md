...
- [x] 商品の登録・一覧表示・編集・削除が動作する
- [x] 花束に対して単品と数量の組合せを登録・削除できる
- [x] 商品一覧画面で商品名・価格・説明が表示される
- [x] 商品詳細画面で構成花材と数量が表示される
...
| カテゴリ | SP | 理想時間 | 状態 |
|---------|----|----|------|
| 商品ドメイン・バックエンド・フロントエンド（US-001） | 3 | 13.5h | [x] |
| 花束構成管理（US-002） | 5 | 14.5h | [x] |
| 商品一覧・詳細表示（US-004） | 3 | 10.5h | [x] |
| IT1 レビュー対応（SP 外） | - | 1h | [x] |
| **合計** | **11** | **39.5h** | |
